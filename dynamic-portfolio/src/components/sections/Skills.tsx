...
export const Skills = () => {
  ...
  return (
    <section id="skills" className="relative bg-slate-950/60 py-24">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {groups.map(([key, group], index) => (
            <motion.article
              ...
              whileHover={{ y: -6 }}
              className="flex flex-col gap-6 rounded-3xl border border-slate-800/70 bg-slate-900/60 p-8 shadow-soft backdrop-blur"
            >
